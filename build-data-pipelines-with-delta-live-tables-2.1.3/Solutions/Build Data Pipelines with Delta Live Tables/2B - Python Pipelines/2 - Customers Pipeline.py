...
# MAGIC * Indicates that all fields should be added to the target table except **`operation`**, and **`_rescued_data`**
...
# MAGIC %md
# MAGIC ## F. Adding this Notebook to a DLT Pipeline
# MAGIC
...
# MAGIC
# MAGIC <img src="https://files.training.databricks.com/images/icon_hint_24.png"> The link to this notebook can be found back in [1b - Using the DLT UI - PART 2 - Customers]($../1b - Using the DLT UI - PART 2 - Customers)<br/>
