...
# MAGIC
# MAGIC Throughout these lessons, we'll set the Python variable **`source`** early in the notebook and then use this variable as necessary in the code. The path points to a Databricks volume.
...
# MAGIC %md
# MAGIC
# MAGIC ## C. Streaming Ingestion with Auto Loader
# MAGIC
...
# MAGIC %md
# MAGIC ## D. Validating, Enriching, and Transforming Data
# MAGIC
...
# MAGIC %md
# MAGIC ## E. Materialized View vs. Streaming Tables
# MAGIC
...
# MAGIC
# MAGIC ### Materialized View (also known as Live Tables)
