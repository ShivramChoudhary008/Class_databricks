...
# MAGIC
# MAGIC Let's start by scheduling the first notebook [2.01 - Ingest CSV]($./Task Notebooks/Lesson 2 Notebooks/2.01 - Ingest CSV) notebook. Click the hotlink in previous sentence to review the code.
# MAGIC
...
# MAGIC <br>
# MAGIC
# MAGIC ![Lesson02_Lab_OneTask](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson02_Lab_OneTask.png)
# MAGIC
# MAGIC 5. Click the **Create task** button.
# MAGIC
# MAGIC 6. Click the blue **Run now** button in the top right to start the job.
# MAGIC
# MAGIC 7. Select the **Runs** tab in the navigation bar and verify that the job completes successfully.
# MAGIC
# MAGIC ![Lesson02_Lab_OneTaskSuccess](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson02_Lab_OneTaskSuccess.png)
# MAGIC
# MAGIC 8. From **Catalog**, navigate to your schema in the **dbacademy** catalog and confirm the table **customers_bronze** was created (you might have refresh your schema).
...
# MAGIC <br></br>
# MAGIC
# MAGIC ![Lesson02_Lab_TwoTasks](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson02_Lab_TwoTasks.png)
...
# MAGIC <br></br>
# MAGIC
# MAGIC ![Lesson02_Lab_ThreeTasks](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson02_Lab_ThreeTasks.png)
...
# MAGIC
# MAGIC <br></br>
# MAGIC ![Lesson02_Lab_SuccessRun](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson02_Lab_SuccessRun.png)
# MAGIC
# MAGIC
