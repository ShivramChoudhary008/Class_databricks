...
# MAGIC
# MAGIC ![Lesson04_FullJobRun](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson04_FullJobRun.png)
...
# MAGIC
# MAGIC   ![Lesson04_DefaultJob](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson04_DefaultJob.png)
...
# MAGIC
# MAGIC ![Lesson04_Clean_Data_Task](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson04_Clean_Data_Task.png)
...
# MAGIC
# MAGIC ![Lesson04_Ingest_Source_1_Failure](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson04_Ingest_Source_1_Failure.png)
...
# MAGIC
# MAGIC
# MAGIC ![Lesson04_RepairRun_01](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson04_RepairRun_01.png)
# MAGIC
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC 6. Click **Save task**.
# MAGIC
# MAGIC ![Lesson04_If_Condition](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson04_If_Condition.png)

# COMMAND ----------

# MAGIC %md
# MAGIC ### E1. Setting Our "False" Task
...
# MAGIC
# MAGIC
# MAGIC ![Lesson04_Fix_Bad_Records_False](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson04_Fix_Bad_Records_False.png)

# COMMAND ----------

# MAGIC %md
# MAGIC ### E2. Aggregate Records Task
...
# MAGIC
# MAGIC ![Lesson04_FullJob](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson04_FullJob.png)

# COMMAND ----------

# MAGIC %md
# MAGIC ### E3. Run the Entire Job
# MAGIC
...
# MAGIC
# MAGIC 1. Click **Run now** to run the entire job. Then in the pop up select **View Run**.
# MAGIC   
...
# MAGIC
# MAGIC ##### Final Run
# MAGIC ![Lesson04_True_run](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson04_True_run.png)
