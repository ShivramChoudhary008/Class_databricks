...
# MAGIC
# MAGIC
# MAGIC ![Lesson01_CreateJob](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson01_CreateJob.png)
...
# MAGIC *Example*
# MAGIC
# MAGIC ![Lesson01_JobRun](files/images/deploy-workloads-with-databricks-workflows-2.0.2/Lesson01_JobRun.png)

# COMMAND ----------

# MAGIC %md
# MAGIC ## G. View Your New Table
